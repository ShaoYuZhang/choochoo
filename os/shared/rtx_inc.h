...
{
  INPUT_KEY_MSG_TYPE,
  COMMAND_REGISTRATION_MSG_TYPE,
  COUNT_REPORT_MSG_TYPE,
  DELAY_SEND_MSG_TYPE,
  PROCESS_A_START_MSG_TYPE,
  WALL_CLOCK_CHANGE_MSG_TYPE,
  WALL_CLOCK_NEXT_SECOND_MSG_TYPE,
  SET_PROCESS_PRIORITY_PROCESS_MSG_TYPE,
  UART_OUTPUT_CHAR_MSG_TYPE,
  CRT_OUTPUT_MSG_TYPE // string in 64-128th byte must bu null terminated. \0
};

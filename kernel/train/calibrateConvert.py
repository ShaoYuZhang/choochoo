...
for i in xrange(0, 13):
  print "{{{0}, {1}}},".format(round(float(lines[i*2][avg_col])), round(float(lines[i*2+1][avg_col])))
print "{{{0}, {1}}}".format(round(float(lines[14*2][avg_col])), round(float(lines[14*2+1][avg_col])))
print "};"
